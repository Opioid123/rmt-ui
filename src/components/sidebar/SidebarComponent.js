...
import ReferenceMappingMenuHeaderComponent from './ReferenceMappingMenuHeaderComponent';
            ...
            <div style={{ position: 'relative' }}>
                <Row className={css(styles.mainContainer)} breakpoints={{ 768: css(styles.mainContainerMobile, expanded && styles.mainContainerExpanded) }}>
                    ...
                    <Column className={css(styles.container)} breakpoints={{ 768: css(styles.containerMobile, expanded ? styles.show : styles.hide) }}>
                        <ReferenceMappingMenuHeaderComponent title="Reference Mapping" />
                        <Column className={css(styles.menuItemList)}>
                            <MenuItemComponent
                                title="Role Maintenance"
                                onClick={() => this.onItemClicked('Role Maintenance')}
                                active={this.props.selectedItem === 'RoleMaintenance'}
                            />
                            <MenuItemComponent
                                title="Admin Maintenance"
                                onClick={() => this.onItemClicked('Admin Maintenance')}
                                active={this.props.selectedItem === 'AdminMaintenance'}
                            />
                            <MenuItemComponent
                                title="Mapping Maintenance"
                                onClick={() => this.onItemClicked('Mapping Maintenance')}
                                active={this.props.selectedItem === 'MappingMaintenance'}
                            />
                        </Column>
                    </Column>
